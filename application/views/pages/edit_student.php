						...
						<form class="form-horizontal" action="<?php echo base_url();?>update-student" method="POST">
						  <fieldset>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="input-xlarge " id="date01" name="subject" required="">
							  </div>
							</div>
							<div class="control-group">
							  <label class="control-label" for="date01">Address</label>
							  <div class="controls">
								<input type="text" class="input-xlarge " id="date01" name="address" required="">
							  </div>
							</div>
							<div class="control-group">
							...
							<div class="control-group">
							  <label class="control-label" for="date01">Registration</label>
							  <div class="controls">
